    ...
    <>
      <Container fixed>
        ...
        <SimpleTypography fontStyle='italic'>
          Now that you are under contract and you have a closing date set, it’s time to start planning your move. It is
          common for your closing date to be extended so keep that in mind when you schedule your movers, utilities,
          etc. Give yourself some wiggle room and be in constant communication with your lender.
        </SimpleTypography>
        <SimpleTypography fontStyle='italic'>
