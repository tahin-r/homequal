...
const Q2 = {
  question          : (state: any) => `Nice to meet you ${ state.first_name }. We will be sending you information you` +
    ' request,specifics' +
    ' about your purchasing ability, and home buying tips. How would you prefer we contact you?',
  description       : 'You will receive a message shortly to confirm your contact information along with your' +
    ' member' +
