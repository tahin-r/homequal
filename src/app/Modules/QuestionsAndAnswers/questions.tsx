...
import { CreateDoubleQuestionsWithTextNumberField }
  from './shared/constructors/aloneRoute/CreateDoubleQuestionsWithTextNumberField'
...
import { CreateDoubleQuestionsWithTextFieldAndRadioCheckBox }
  from './shared/constructors/aloneRoute/CreateDoubleQuestionsWithTextFieldAndRadioCheckBox'
...
export interface ICreateDoubleQuestionsWithTextNumberField extends basicTypes {
  question1: (state: FormikValues) => string
  firstInputs: { value: string, text: string }[]
  secondInputs: { value: string, text: string }[]
}

export interface ICreateDoubleQuestionsWithTextFieldAndRadioCheckBox extends basicTypes {
...
const Q2: ICreateRadio_CheckBox_Question = {
  ...
  description:
    `You will receive a message shortly to confirm your contact information along with
     your member account access instructions.`,
...
const Q10: ICreateRadio_CheckBox_Question = {
  ...
  description:
    `Tip: When starting the mortgage process, be careful moving money in and out of accounts 
    or having any large deposits.  Lenders will ask a lot of questions if you do!`,
...
const Q15: ICreateRadio_CheckBox_Question = {
  ...
  description:
    `Checking any of these does not mean you will be denied. It just means you will need further 
    documentation. We’ll help you with that.`,
  elementConstructor: CreateCheckBoxQuestion,
...
const Q16: ICreateRadio_CheckBox_Question = {
  question: () =>
    `Your credit score plays a major role in both your approvability odds as well as the interest rate. 
    What do you think your credit score is?`,
  description:
    `If you are unsure, give us your best guess and we’ll figure it out later. Don’t worry 
    if your score isn’t where you want it, we have strategies to help you improve yours fast.`,
  elementConstructor: CreateRadioQuestion,
...
const Q22: ICreateAutoCompleteQuestion = {
  question: () =>
    `And finally, where would you like to live? A major part of your mortgage payment is taxes. 
    By providing a general area, we can calculate your taxes!`,
  description:
...
const Q16C: ICreateDoubledCheck_Radio_BoxQuestion = {
  question: () =>
    `Your credit score plays a major role in both your approvability odds as well 
    as the interest rate. What do you think your credit score is?`,
  description:
    `If you are unsure, give us your best guess and we’ll figure it out later. 
    Don’t worry if your score isn’t where you want it, we have strategies to help you improve yours fast.`,
...
const Q17C: ICreateDoubledCheck_Radio_BoxQuestion = {
  question: () =>
    'Lenders will analyze your employment history. Check any below that apply to you.',
  description:
    `Checking any of these does not mean you will be denied. It just means you will need 
    further documentation. We’ll help you with that.`,
  elementConstructor: CreateDoubledCheckBoxQuestion,
  formName: 'member_buyer_details',
  co_formName: 'co_member_buyer_details',
  current: 'Q17C',
...
const Q3R: ICreateDoubleQuestionsWithTextNumberField = {
...
const Q4R: ICreateDoubleQuestionsWithTextFieldAndRadioCheckBox = {
  question: () => 'What is your interest rate?',
  secondQuestion: () => 'What type of loan do you have?',
  description: '',
  elementConstructor: CreateDoubleQuestionsWithTextFieldAndRadioCheckBox,
  current: 'Q4',
  next: 'Q5',
