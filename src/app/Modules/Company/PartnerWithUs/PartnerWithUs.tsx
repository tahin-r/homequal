...
import partnerwithus                        from '../../../../assets/images/PartnerWithUs/partnerwithus.jpeg'
import { GreyTextContainer, TextContainer } from '../../Dashboard/Sections/DetermineYouHome';
...
const Content = styled.div`
  ...
  background      : url(${ partnerwithus }) center right no-repeat border-box;
    ...
    <Grid>
      <Content>
        <Typography
          variant="h4"
          color="primary"
          sx={ { maxWidth: '30vw', minWidth: '160px', fontWeight: 'bold' } }
      ...
      <LeftSidedText>
        <Typography variant="h5" sx={{fontStyle:'italic'}}>
          “I love working with HomeQual clients.  They are educated, equipped and ready to buy their first home.  A great service!”
        </Typography>
      </LeftSidedText>
