...
const usersFeedback: Array<IUsersFeedback> = [
  {
    name: 'Eric & Yen',
    nickName: '',
    text: `Great company! Highly recommended for first time home buyers. 
    Extremely helpful in navigating through the complex process of purchasing a home.`,
    imageUrl: Eric
  },
  {
    name: 'Bradley & Lee',
    nickName: '',
    text: `Great place to start if this is your first home. They have walked us through every 
    step and were there whenever we had questions no matter what time it was.`,
    imageUrl: Bradley
  },
  {
    name: 'Jerry',
  ...
  },
  {
    name: 'Jay',
    nickName: '',
    text: `As a first time home buyer, I was amazed by how easy and quick the home buying process was.
     I would recommend it to anyone who is interested in buying their first home and don’t know where to start.`,
    imageUrl: Jay
  },
  {
    name: 'Joshua',
    nickName: '',
    text: `First time home buying made easy. Great people all the way through the process. 
    I would consider them friend and this point. Really took the uncertainty our of my home buying experience.`,
    imageUrl: Joshua
  }
]
